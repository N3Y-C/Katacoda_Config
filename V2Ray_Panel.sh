...
install_v2-ui() {
    ...
    echo -e "${green}v2-ui v${last_version}${plain} Instalacion-completa，El-panel-esta-activado，"
    echo -e ""
    ...
    echo -e "v2-ui Como usar el Script de Gestion: "
    echo -e "----------------------------------------------"
    echo -e "v2-ui              - Mostrar el menú de administración (más funciones)"
    echo -e "v2-ui start        - Iniciar el Panel V2-UI"
    echo -e "v2-ui stop         - Detener el Panel V2-UI"
    echo -e "v2-ui restart      - Reiniciar el Panel V2-UI"
    echo -e "v2-ui status       - Ver el estado de V2-UI"
    echo -e "v2-ui enable       - Configurar V2-UI para que se inicie solo"
    echo -e "v2-ui disable      - Cancelar el arranque de V2-UI"
    echo -e "v2-ui log          - Ver los registros de V2-UI"
    echo -e "v2-ui update       - Actualizacion del Panel V2-UI"
    echo -e "v2-ui install      - Instalacion del Panel V2-UI"
    echo -e "v2-ui uninstall    - Desinstalar el Panel V2-UI"
    echo -e "----------------------------------------------"
}

echo -e "${green}Iniciar-la-instalacion${plain}"
install_base
uninstall_old_v2ray
#close_firewall
install_v2-ui $1
